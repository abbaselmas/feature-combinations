...
Detectors      = list([sift, orb])
Descriptors    = list([boost1, boost2, boost3, boost4, boost5, boost6])
matching       = list([cv2.NORM_L2]) #, cv2.NORM_HAMMING, , cv2.NORM_L2
...
# export numpy arrays
np.save(maindir + "/arrays/Rate_graf_single.npy", Rate_graf)
np.save(maindir + "/arrays/Exec_time_graf_single.npy", Exec_time_graf)
##########################################################
