...
hl    = cv2.xfeatures2d.HarrisLaplaceFeatureDetector.create()
msd   = cv2.xfeatures2d.MSDDetector.create()
tbmr  = cv2.xfeatures2d.TBMR.create()
### descriptors 9
vgg   = cv2.xfeatures2d.VGG.create()
