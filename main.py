...
### descriptors 9
vgg   = cv2.xfeatures2d.VGG_create(desc=cv2.xfeatures2d.VGG.VGG_64 ,isigma=1.4, img_normalize=True, use_scale_orientation=False, scale_factor=6.25, dsc_normalize=False)
