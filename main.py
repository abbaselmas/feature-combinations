...
for g in range(6): # for the 6 images (img1, img2, img3, img4, img5, img6
    for c3 in range(len(matching)): # for bf.L1 and bf.L2 mapping
        for i in range(len(Detectors)):
            ...
            logging.info(print("Detector ", method_dtect, " is calculated for all images within ", Execution_times[g, c3, i, 0, 0], " seconds."))
            for j in range(len(Descriptors)):
                method_dscrpt = Descriptors[j]
                try:
                    start_time = time.time()
                    ...
                    logging.info(print("Descriptor ", method_dscrpt," is calculated for all images within ",Execution_times[g, c3, i, j, 1], " seconds."))
                    start_time = time.time()
                    ...
                    logging.info(print("Scenario 4 graf:" , g , "Detector ", method_dtect , " Descriptor " , method_dscrpt , " Matching " , matching[c3] , " is calculated within " , Execution_times[g, c3, i, j, 2] , " seconds."))
                except Exception as e:
                    logging.info(print("Combination of detector", method_dtect, ", descriptor ", method_dscrpt, " and matching",matching[c3], "is not possible."))
